# Recap -- experiment_verification_2026_09_17
_Generato: 2026-09-17 16:20 UTC_
...
> 💸 **Analisi controfattuale costo di retrieval** (F vs B stesso task, stesso experiment_id -- zero chiamate nuove): su 6 quest con skill iniettata, **0 (0.0%)** hanno visto B passare comunque senza alcun aiuto -- overhead di token pagato senza beneficio misurato su quella quest specifica (0 token totali). 6 quest mostrano un beneficio reale (B falliva, F ha passato), 0 mostrano lo skill peggiorare l'esito (spesso il sintomo di un difetto nel benchmark, non dello skill -- controlla sopra). Pattern con almeno un beneficio misurato in questo run: floating_point_equality, wrong_string_case_comparison.
...
|---|---|---|---|---|---|
| A | KNOWN | 10 | 100.0% | $0.0000 | 6372 |
| A | NOVEL | 8 | 100.0% | $0.0000 | 5385 |
| A | VARIANT | 21 | 100.0% | $0.0000 | 7784 |
| B | KNOWN | 10 | 70.0% | $0.0000 | 9179 |
| B | NOVEL | 8 | 75.0% | $0.0000 | 8347 |
| B | VARIANT | 21 | 71.4% | $0.0000 | 13912 |
| C | KNOWN | 10 | 90.0% | $0.0000 | 8381 |
| C | NOVEL | 8 | 87.5% | $0.0000 | 7751 |
| C | VARIANT | 21 | 66.7% | $0.0000 | 8754 |
| F | KNOWN | 10 | 60.0% | $0.0000 | 11528 |
| F | NOVEL | 8 | 62.5% | $0.0000 | 9102 |
| F | VARIANT | 21 | 76.2% | $0.0000 | 12064 |

**Totali per config:**
- A -- Expert da solo: accuracy 100.0%, costo totale $0.0000, latenza media 6930ms, n=39
- B -- Small da solo: accuracy 71.8%, costo totale $0.0000, latenza media 11557ms, n=39
- F -- Small + Librarian: accuracy 69.2%, costo totale $0.0000, latenza media 11319ms, n=39
- C -- Small + Cheater (soluzione pregressa): accuracy 76.9%, costo totale $0.0000, latenza media 8453ms, n=39
- B vs A (Small senza aiuto vs Expert): -28.2% accuracy
- F vs B (effetto della Libreria sul modello Small): -2.6% accuracy
- F vs A (quanto F si avvicina all'Expert): -30.8% accuracy
- C vs B (l'accesso a una soluzione pregressa aiuta rispetto a niente?): +5.1% accuracy
- C vs F (soluzione specifica vs skill generalizzata -- la domanda centrale del Cheater Agent): +7.7% accuracy
...
| NONE | 33 | 63.6% |
| FULL | 6 | 100.0% |
- Δ Retrieval (FULL − NONE, dentro F stesso): +36.4%
- Δ Architecture (F-FULL − B): +28.2%
...
| PARTIAL | 21 | 66.7% |
| FULL | 10 | 90.0% |
- Δ Retrieval (FULL − NONE, dentro C stesso): +2.5%
- Δ Architecture (C-FULL − B): +18.2%
...
|---|---|---|---|---|---|---|---|---|
| A | 39 | 5943 | 2680 | 41897 | 50520 | 1295 | 1295 | 100.0% |
| B | 39 | 7542 | 2994 | 0 | 10536 | 270 | 376 | 71.8% |
| F | 39 | 25335 | 3464 | 0 | 28799 | 738 | 1067 | 69.2% |
| C | 39 | 10902 | 2948 | 0 | 13850 | 355 | 462 | 76.9% |
...
- Overhead della Libreria (F vs B, stesso task): +456 token di input in media (min 413, max 892) -- il costo di *usare* uno skill gia' pronto.
...
|---|---|---|---|---|---|---|
| `floating_point_equality` | 36945 | 2 | 3676 | 1114 | +2561 | 14.4 usi |
| `wrong_string_case_comparison` | 6985 | 4 | 1999 | 814 | +1184 | 5.9 usi |

## 6. Quest fallite
- **B** [KNOWN] `floating_point_equality__average_matches_target__known_example`
- **B** [VARIANT] `floating_point_equality__temperature_reached__variant`
- **B** [NOVEL] `incorrect_sort_key_or_order__dedupe_preserve_order__novel_b`
- **B** [VARIANT] `inverted_boolean_logic__is_valid_username__variant2`
- **B** [KNOWN] `mutable_default_argument__dedupe_preserve_order__known_example`
- **B** [NOVEL] `variable_shadowing__reverse_words__novel_b`
- **B** [VARIANT] `wrong_comparison_operator__is_valid_password__variant2`
- **B** [VARIANT] `wrong_string_case_comparison__count_vowels__variant2`
- **B** [KNOWN] `wrong_string_case_comparison__find_matching_tag__known_example`
- **B** [VARIANT] `wrong_string_case_comparison__is_palindrome__variant2`
...
- **C** [KNOWN] `index_out_of_range_boundary__run_length_encode__known_example`
- **C** [VARIANT] `inverted_boolean_logic__is_valid_username__variant2`
- **C** [VARIANT] `mutable_default_argument__flatten_list__variant`
- **C** [NOVEL] `variable_shadowing__reverse_words__novel_b`
- **C** [VARIANT] `wrong_comparison_operator__is_valid_password__variant2`
- **C** [VARIANT] `wrong_string_case_comparison__count_vowels__variant2`
- **C** [VARIANT] `wrong_string_case_comparison__is_palindrome__variant2`
- **C** [VARIANT] `wrong_string_case_comparison__is_valid_username__variant`
- **F** [NOVEL] `incorrect_sort_key_or_order__dedupe_preserve_order__novel_b`
- **F** [NOVEL] `incorrect_sort_key_or_order__merge_intervals__novel_a`
- **F** [VARIANT] `index_out_of_range_boundary__merge_intervals__variant2`
- **F** [KNOWN] `index_out_of_range_boundary__run_length_encode__known_example`
- **F** [KNOWN] `inverted_boolean_logic__is_leap_year__known_example`
- **F** [KNOWN] `mutable_default_argument__dedupe_preserve_order__known_example`
- **F** [VARIANT] `mutable_default_argument__flatten_list__variant`
- **F** [NOVEL] `variable_shadowing__reverse_words__novel_b`
- **F** [VARIANT] `wrong_accumulator_init__reverse_words__variant`
- **F** [VARIANT] `wrong_accumulator_init__sum_scores_by_player__variant2`
- **F** [VARIANT] `wrong_comparison_operator__is_valid_password__variant2`
- **F** [KNOWN] `wrong_comparison_operator__merge_intervals__known_example`

**Pattern di bug con fallimenti in piu' di un config:**
- `floating_point_equality`: B su floating_point_equality__average_matches_target__known_example, floating_point_equality__temperature_reached__variant, C su floating_point_equality__temperature_reached__variant -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.
- `incorrect_sort_key_or_order`: B su incorrect_sort_key_or_order__dedupe_preserve_order__novel_b, F su incorrect_sort_key_or_order__dedupe_preserve_order__novel_b, incorrect_sort_key_or_order__merge_intervals__novel_a -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.
- `index_out_of_range_boundary`: F su index_out_of_range_boundary__merge_intervals__variant2, index_out_of_range_boundary__run_length_encode__known_example, C su index_out_of_range_boundary__run_length_encode__known_example -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.
- `inverted_boolean_logic`: B su inverted_boolean_logic__is_valid_username__variant2, F su inverted_boolean_logic__is_leap_year__known_example, C su inverted_boolean_logic__is_valid_username__variant2 -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.
- `mutable_default_argument`: B su mutable_default_argument__dedupe_preserve_order__known_example, F su mutable_default_argument__dedupe_preserve_order__known_example, mutable_default_argument__flatten_list__variant, C su mutable_default_argument__flatten_list__variant -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.
- `variable_shadowing`: B su variable_shadowing__reverse_words__novel_b, F su variable_shadowing__reverse_words__novel_b, C su variable_shadowing__reverse_words__novel_b -- stesso task, probabilmente e' il task in se' ad essere difficile per tutti (non e' una domanda sulla Libreria).
- `wrong_comparison_operator`: B su wrong_comparison_operator__is_valid_password__variant2, F su wrong_comparison_operator__is_valid_password__variant2, wrong_comparison_operator__merge_intervals__known_example, C su wrong_comparison_operator__is_valid_password__variant2 -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.
- `wrong_string_case_comparison`: B su wrong_string_case_comparison__count_vowels__variant2, wrong_string_case_comparison__find_matching_tag__known_example, wrong_string_case_comparison__is_palindrome__variant2, wrong_string_case_comparison__is_valid_username__variant, C su wrong_string_case_comparison__count_vowels__variant2, wrong_string_case_comparison__is_palindrome__variant2, wrong_string_case_comparison__is_valid_username__variant -- **task diversi della stessa famiglia di bug** falliscono su config diversi. Da controllare quest per quest in `observer_table.csv` (colonna `retrieved_tokens`) se lo skill recuperato e' lo stesso e se l'ha aiutato o confuso.

## 7. Uso degli skill (Librarian)
| skill | usi | token medi | quest passate su quest usate |
|---|---|---|---|
| `book_floating_point_equality_v4_v5_v6` | 2 | 976 | 2/2 |
| `book_general_case_completeness` | 39 | 523 | 27/39 |
| `book_wrong_string_case_comparison_v2_v3` | 4 | 678 | 4/4 |
| `solution_average_matches_target` | 2 | 68 | 1/2 |
| `solution_binary_search` | 4 | 111 | 4/4 |
| `solution_count_vowels` | 4 | 79 | 4/4 |
| `solution_count_word_frequency` | 2 | 76 | 2/2 |
| `solution_dedupe_preserve_order` | 2 | 94 | 1/2 |
| `solution_find_matching_tag` | 4 | 86 | 1/4 |
| `solution_is_leap_year` | 3 | 70 | 2/3 |
| `solution_merge_intervals` | 4 | 134 | 3/4 |
| `solution_rolling_average` | 3 | 91 | 3/3 |
| `solution_run_length_encode` | 3 | 124 | 2/3 |
...
| `numerical_computing` | floating_point_equality, integer_division_truncation | COVERED | 2 | 2 | 36945 |
