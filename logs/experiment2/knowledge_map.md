...
|---|---|---|---|---|---|---|---|
| `boundary_conditions` (Boundary Conditions) | off_by_one, wrong_comparison_operator, index_out_of_range_boundary, wrong_return_in_loop | PARTIALLY_COVERED | 3 | 3 | 6 | 54871 | +173 |
| `numerical_computing` (Numerical Computing) | floating_point_equality, integer_division_truncation | COVERED | 2 | 2 | 4 | 65369 | +362 |
| `loop_state` (Loop State & Accumulation) | wrong_accumulator_init | COVERED | 1 | 1 | 2 | 26219 | +76 |
| `language_semantics` (Python Language Semantics) | mutable_default_argument, variable_shadowing | PARTIALLY_COVERED | 1 | 1 | 2 | 27080 | +536 |
| `boolean_logic` (Boolean Logic) | inverted_boolean_logic | COVERED | 1 | 1 | 2 | 20746 | +102 |
| `data_ordering` (Data Ordering) | incorrect_sort_key_or_order | EMPTY | 0 | 0 | 0 | 0 | n/d |
| `data_structures` (Data Structures) | key_error_missing_dict_check | COVERED | 1 | 1 | 2 | 7353 | -76 |
| `string_processing` (String & Text Processing) | wrong_string_case_comparison | COVERED | 1 | 1 | 2 | 6985 | +647 |
